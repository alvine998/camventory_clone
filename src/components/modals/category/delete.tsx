...
export default function CategoryDeleteModal({ open, setOpen, data }: Props) {
  ...
  const onSubmit = async (e: any) => {
    ...
    try {
      ...
      await axios.delete("/api/category", { data: payload });
      Swal.fire({
        icon: "success",
        title: "Category Items Deleted Successfully",
